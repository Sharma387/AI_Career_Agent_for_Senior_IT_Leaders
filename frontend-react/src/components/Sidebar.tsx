...
const links = [
  ...
  { to: '/interview-prep', label: 'Interview Prep', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
];
  ...
  return (
    <aside className="w-64 bg-sidebar-bg text-white flex flex-col">
      <div className="p-6 border-b border-slate-700">
        <h1 className="text-xl font-bold text-white">AI Career Agent</h1>
        <p className="text-sm text-slate-400 mt-1">Senior IT Leaders</p>
      </div>
